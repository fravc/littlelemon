...
const BookingForm = ({ availableTimes, updateTimes, onSubmitForm }) => {
    ...
    return (
      <form onSubmit={handleSubmit} style={{ display: 'grid', maxWidth: '200px', gap: '20px' }}>
        ...
        <input type="number" name="numberGuests" placeholder="1" min="0" max="10" id="guests" onChange={onFormDataChange}  value={formData.numberGuests}/>
